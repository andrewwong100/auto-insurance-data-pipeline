...
DATASET = 'claim_payments'
FIELDS = ['payment_id', 'claim_id', 'policy_id', 'payment_date', 'payment_type', 'payee_type', 'amount', 'currency', 'source_event_id', 'source_version', 'source_system', 'created_at', 'updated_at']
ID_FIELD = 'payment_id'
